...
from solar_farm_definer_class import SolarFarmDefine
from solar_farm_definer_class import SolarFarmSolver
from Simulator import SolarFarmSolverSim
import copy
...
panel_params = {
    ...
    'K_V': -0.271, 
    'K_I': 0.038, 
    'Ns': 72*1 #12*m only for aggregated model. For indie panel its 12*1
}
