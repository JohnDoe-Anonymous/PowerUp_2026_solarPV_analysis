...
from solar_farm_definer_class_diode import SolarFarmDefine
from solar_farm_definer_class_diode import SolarFarmSolver
from Simulator_diode import SolarFarmSolverSim
import copy
...
panel_params = {
    ...
    'K_V': -0.271, 
    'K_I': 0.038, 
    'Ns': 12*1 #12*m only for aggregated model. For indie panel its 12*1
}
